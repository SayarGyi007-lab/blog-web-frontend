...
function Header() {
    ...
    <div className='space-x-4'>
       
        {
            userInfo? 
            <>
                <Link to='#' className='text-white bg-black py-2 px-4 rounded-md'>Profile</Link>
                <Link to='/post/create' className='text-white bg-black py-2 px-4 rounded-md'>Upload</Link>
